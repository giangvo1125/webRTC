...
class TableHTFTComponent extends Component{
...
TableHTFTComponent.contextTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(TableHTFTComponent)