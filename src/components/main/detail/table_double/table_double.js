...
class TableDoubleLeagueComponent extends Component{
...
TableDoubleLeagueComponent.contextTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(TableDoubleLeagueComponent)